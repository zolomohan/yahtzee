...
const threeOfKind = new SumDistro({ count: 3, description: 'Sum all dice if 3 are same' });
const fourOfKind = new SumDistro({ count: 4, description: 'Sum all dice if 4 are same' });
...
const yahtzee = new Yahtzee({ score: 50, description: '50 Points if all dice are same' });
